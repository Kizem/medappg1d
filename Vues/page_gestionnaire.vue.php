      ...
      <div class="options">
        ...
        <div class="catégorie">
          ...
          <ul class="Actions">
            ...
            <li class="Del_cap"><a href="page_gestionnaire.php?delete_cap=<?= $c['idCapteur']?>" onclick="return confirm('Etes-vous sûr de vouloir effectuer la suppresion ?');">Supprimer</a></li>
