        ...
        <section class="section">
            ...
            <article class="texte">
                <div class="zoneArticle">
                        ...
                        <p>Ce site est édité par la société  {nom_société}.</p>

                        <p>Siège social : {nom_société} {nom_adresse}
                        Capital social : XXXXX euros
                        Téléphone : +33 (0)4.74.00.00.00</p>

                        <p>Responsable de la rédaction :</p>

                        <p>Développement, hébergement :<br />
                        Ice development – www.ice-dev.com<br />
                        16 rue Maurice Bouchor - 69007 Lyon<br />
                        Tél : 08 21 23 03 54</p>

                        <h3>Informatique et liberté</h3>

                        <p>Aucune information personnelle n'est collectée à votre insu. Les informations que vous nous communiquez lors d’une demande de devis, de renseignements ou d’inscription à la newsletter par courrier, par téléphone, par e-mail ou par formulaire sont uniquement destinées au traitement administratif et commercial de votre demande par la société {nom_société}.</p>

                        <p>Elles ne font l'objet d'aucune cession à des tiers. {nom_société}  traite les informations qui vous concernent avec la plus grande confidentialité.</p>
                        ...
                        <h3>Droit d'auteur / copyright</h3>

                        <p>L'ensemble du contenu du présent site Internet, y compris nom de domaine, marques, logo, texte… est la propriété de la société ___________, il est protégé par les lois en vigueur de la législation française sur la propriété intellectuelle.</p>
                        ...
                        <p>Les liens hypertextes mis en oeuvre au sein du présent site Internet, en direction d'autres sites et/ou de pages personnelles et d'une manière générale vers toutes ressources existantes sur Internet, ne sauraient engager la responsabilité de _________.
                        De même que la société {nom_société}  ne pourra en aucune façon être tenue pour responsable des sites ayant un lien hypertexte avec le présent site et décline toute responsabilité quant à leur contenu et à leur utilisation.</p>

                         

                        <p>Source : http://www.journaldunet.com/ebusiness/le-net/mentions-legales-site.shtml</p>
                        ...
                        <p>L’utilisateur reconnaît que les données circulant sur Internet ne sont pas protégées notamment contre les détournements éventuels. La présence du logo   ____  institue une présomption simple de validité. La communication de toute information jugée par l’utilisateur de nature sensible ou confidentielle se fait à ses risques et périls.</p>
                        ...
                        <p>Source : http://www.droitissimo.com/contrat/conditions-generales-dutilisation-cgu-dun-site-internet </p>
                    </div>
            </article>
        </section>
        <!-- PIED DE PAGE -->
